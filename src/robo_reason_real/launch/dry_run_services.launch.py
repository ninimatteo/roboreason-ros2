...
Usage:
  ...
  ros2 launch robo_reason_real dry_run_services.launch.py

  # Real LLM mode (GROQ_API_KEY must be set):
  ros2 launch robo_reason_real dry_run_services.launch.py use_mock_llm:=false reasoning_method:=fhp
"""
