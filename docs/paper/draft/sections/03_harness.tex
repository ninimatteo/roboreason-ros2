...
plan was grounded in, \rev{which is what made it possible to diagnose the
failures reported in \S\ref{sec:taxonomy}: each bug there} was traced
from a hardware failure back to a specific malformed field in a specific
logged response, not inferred after the fact. A web GUI supervises the whole
