...
semi-automatic adaptation). Neither it nor a related simulation
framework for the same class of reasoning
strategies~\cite{favaliRoboReasonLab} ever grounds a plan in measured
depth or a calibrated camera; both are simulation-only by design, and so
