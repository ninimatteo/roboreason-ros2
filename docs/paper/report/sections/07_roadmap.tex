...
live hardware, not a replayed/synthetic check -- the strongest verification
either could have gotten, and neither fix is implicated in any of the
120 trials' incidents (all collisions during multi-object placement, none
a wrong height or missed footprint). Kept here, marked done, rather than
removed, since this paragraph was the gate the rest of this roadmap was
written to wait on.
